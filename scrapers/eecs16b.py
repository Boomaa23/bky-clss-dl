...
class EECS16BScraper(common.AbstractCourseScraper):
    def __init__(self):
        super().__init__("ee16b", ("sp22",), override_url="https://eecs16b.org")
        self.name = "eecs16b"
                ...
                for elem in href_elems:
                    ...
                    if col_num == 0:
                        ...
                        if text and 'datahub' not in href and \
                                ('Lab Note' in text or 'ZIP File' in text):
                            if 'drive.google.com' in href:
